...
function Page1() {
    const [formData, setFormData] = useState({ id: "", name: "", role: "", email: "", tele: "" });
    const [showModal, setShowModal] = useState(false);
    const [modalAction, setModalAction] = useState("");
    const [users, setUsers] = useState([
        { id: "01", name: "Wickramasinghe", role: "CEO", email: "wik@gmail.com", tele: "123 456 7890" },
        { id: "02", name: "Sirisena", role: "PM", email: "siri@gmail.com", tele: "098 765 4321" }
    ]);
        ...
        <div className="p-3">
            ...
            <div>
                <Breadcrumb>
                    ...
                    <Breadcrumb linkAs={Link} linkProps={{ to: "/user" }}>
                        User Management
                    </Breadcrumb>
                </Breadcrumb>
            </div>
            ...
            <Modal show={showModal} onHide={handleModalClose}>
                <Modal.Header closeButton>
                    <Modal.Title>
                        {modalAction === "Delete" ? "Confirm Delete" : modalAction + " User"}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {modalAction === "Delete" ? (
